...
urlpatterns = [
    ...
    path('admin/', views.create_event, name='admin'),  # Admin event and category creation
    path('create-category/', views.create_category, name='create_category'),  # Create category URL
