...
class VendorAdmin(admin.ModelAdmin):
    ...
    def username(self, obj):
        return obj.username  # Access the username directly from the Vendor model
    username.admin_order_field = 'username'  # Allows sorting by username in the admin interface
