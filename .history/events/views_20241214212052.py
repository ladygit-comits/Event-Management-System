...
from .forms import EventForm, RegistrationForm, CategoryForm, WaitingListForm
...
def user_dashboard(request):
    # Filter user's registrations and waiting list entries
    user_email = request.user.email  # Email is used to link registrations to the user
    user_registrations = Registration.objects.filter(email=user_email)
    user_waiting_list = WaitingList.objects.filter(email=user_email)
