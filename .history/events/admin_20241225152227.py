...
class VendorAdmin(admin.ModelAdmin):
    list_display = ('id', 'username', 'business_name', 'contact_person', 'email', 'phone_number', 'category', 'approved', 'created_at')
    list_filter = ('approved', 'category', 'created_at')
    search_fields = ('username', 'business_name', 'contact_person', 'email', 'phone_number', 'category')
    ...
    def username(self, obj):
        return obj.user.username  # Assuming the Vendor model has a ForeignKey to User
    username.admin_order_field = 'user__username'  # Allows sorting by username in the admin interface
